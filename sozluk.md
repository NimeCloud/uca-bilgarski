...
| isim | **име** (nötr) | ime |
| adam | **мъж** (eril) | mıj |
| kadın | **жена** (dişil) | jena |
| çocuk | **дете** (nötr) | dete |
| insan | **човек** (eril) | chovek |
| arkadaş | **приятел** (eril) | priyatel |
| arkadaş (kız) | **приятелка** (dişil) | priyatelka |
| öğrenci | **студент / ученик** | student / uçenik |
| komşu | **съсед** (eril) / **съседка** (dişil) | sısed / sısedka |
| Türk | **турчин** (eril) / **туркиня** (dişil) | turçin / turkinya |
| Bulgar | **българин** (eril) / **българка** (dişil) | bılgarin / bılgarka |

> **Örnek:** Аз съм турчин. (Az sım turçin.) — Ben Türk'üm.  
> **Örnek:** Тя е моя приятелка. (Tya e moya priyatelka.) — O benim arkadaşım (kız).  
> **Çoğul:** Те са мои приятели. (Te sa moi priyateli.) — Onlar benim arkadaşlarım.
...
|--------|----------|--------|
| ev | **къща** (dişil) | kışta |
| apartman | **апартамент** (eril) | apartament |
| oda | **стая** (dişil) | staya |
| mutfak | **кухня** (dişil) | kuhnya |
| banyo | **баня** (dişil) | banya |
| kapı | **врата** (dişil) | vrata |
| pencere | **прозорец** (eril) | prozorets |
| masa | **маса** (dişil) | masa |
| sandalye | **стол** (eril) | stol |
| yatak | **легло** (nötr) | leglo |
| anahtar | **ключ** (eril) | klyuch |
| telefon | **телефон** (eril) | telefon |
| bilgisayar | **компютър** (eril) | kompyutır |
| kitap | **книга** (dişil) | kniga |
| kalem | **химикалка** (dişil) | himikalka |
| çanta | **чанта** (dişil) | chanta |
| saat | **час** (eril) / **часовник** (eril) | chas / chasovnik |
| para | **пари** (çoğul) | pari |

> **Örnek:** Аз живея в апартамент. (Az jiveya v apartament.) — Ben apartmanda yaşıyorum.  
> **Çoğul:** Вкъщи имам два стола. (Vkashti imam dva stola.) — Evde iki sandalyem var.  
> **Örnek:** Моят телефон е нов. (Moyat telefon e nov.) — Benim telefonum yeni.  
> **Dişil:** Моята книга е интересна. (Moyata kniga e interesna.) — Benim kitabım ilginç.
...
| Türkçe | Bulgarca | Okunuş |
|--------|----------|--------|
| ekmek | **хляб** (eril) | hlyab |
| su | **вода** (dişil) | voda |
| süt | **мляко** (nötr) | mlyako |
| kahve | **кафе** (nötr) | kafe |
| çay | **чай** (eril) | çay |
| şarap | **вино** (nötr) | vino |
| bira | **бира** (dişil) | bira |
| et | **месо** (nötr) | meso |
| balık | **риба** (dişil) | riba |
| sebze | **зеленчук** (eril) | zelenchuk |
| meyve | **плод** (eril) | plod |
| elma | **ябълка** (dişil) | yabılka |
| çorba | **супа** (dişil) / **чорба** (dişil) | supa / chorba |
| salata | **салата** (dişil) | salata |
| peynir | **сирене** (nötr) | sirene |
| şeker | **захар** (dişil) | zahar |
| tuz | **сол** (dişil) | sol |
| bardak | **чаша** (dişil) | chasha |
| tabak | **чиния** (dişil) | chiniya |

> **Örnek:** Аз пия кафе всяка сутрин. (Az piya kafe vsyaka sutrin.) — Ben her sabah kahve içerim.  
> **Örnek:** Аз ям хляб и сирене за закуска. (Az yam hlyab i sirene za zakuska.) — Kahvaltıda ekmek ve peynir yerim.  
> **Çoğul:** Аз купувам плодове от пазара. (Az kupuvam plodove ot pazara.) — Pazardan meyveler alıyorum.
...
| Türkçe | Bulgarca | Okunuş |
|--------|----------|--------|
| gitmek | **отивам** | otivam |
| gelmek | **идвам** | idvam |
| yürümek | **ходя** | hodya |
| koşmak | **бягам** | byagam |
| durmak | **спирам** | spi ram |
| oturmak | **седя** | sedya |
...
| dinlemek | **слушам** | slusham |
| duymak | **чувам** | chuvam |
| bakmak | **гледам** | gledam |
| görmek | **виждам** | vizhdam |
| bilmek | **зная** | znaya |
| istemek | **искам** | iskam |
...
> **Örnek:** Аз работя в офис. (Az rabotya v ofis.) — Ben ofiste çalışıyorum.  
> **Örnek:** Аз обичам да чета книги. (Az obicham da cheta knigi.) — Ben kitap okumayı severim.  
> **Örnek:** Аз ходя на работа всеки ден. (Az hodya na rabota vseki den.) — Her gün işe giderim.
...
| sonra | **после** | posle |
| önce | **преди** | predi |
| hemen | **веднага** | vednaga |
| sabah | **сутрин** | sutrin |
| öğle | **обед** (eril) | obed |
| akşam | **вечер** (dişil) | veçer |
| gece | **нощ** (dişil) | nosht |
| gün | **ден** (eril) | den |
| hafta | **седмица** (dişil) | sedmitsa |
| ay | **месец** (eril) | mesets |
| yıl | **година** (dişil) | godina |
| saat | **час** (eril) | chas |
| dakika | **минута** (dişil) | minuta |

> **Örnek:** Аз ставам в седем часа сутринта. (Az stavam v sedem chasa sutrinta.) — Sabah saat yedide kalkıyorum.  
> **Örnek:** Аз спя осем часа всяка нощ. (Az spya osem chasa vsyaka nosht.) — Her gece sekiz saat uyurum.  
> **Örnek:** Днес съм свободен. (Dnes sım svoboden.) — Bugün boşum.
...
|--------|-----------------|-------------------|------------------|--------|
| kırmızı | **червен** | **червена** | **червено** | çerven |
| mavi | **син** | **синя** | **синьо** | sin |
| yeşil | **зелен** | **зелена** | **зелено** | zelen |
| sarı | **жълт** | **жълта** | **жълто** | jılt |
| beyaz | **бял** | **бяла** | **бяло** | byal |
| siyah | **черен** | **черна** | **черно** | çeren |
| büyük | **голям** | **голяма** | **голямо** | golyam |
| küçük | **малък** | **малка** | **малко** | malık |
| güzel | **красив** | **красива** | **красиво** | krasiv |
| iyi | **добър** | **добра** | **добро** | dobır |
| kötü | **лош** | **лоша** | **лошо** | losh |
| sıcak | **топъл** | **топла** | **топло** | topıl |
| soğuk | **студен** | **студена** | **студено** | studen |
| yeni | **нов** | **нова** | **ново** | nov |
| eski | **стар** | **стара** | **старо** | star |

> **Örnek:** Аз имам червена кола. (Az imam chervena kola.) — Benim kırmızı bir arabam var.  
> **Örnek:** Моят апартамент е голям. (Moyat apartament e golyam.) — Benim dairem büyük.  
> **Örnek:** Днес е много студено. (Dnes e mnogo studeno.) — Bugün çok soğuk.  
> **Nötr:** Това е красиво място. (Tova e krasivo myasto.) — Burası güzel bir yer.
...
> **Birinci şahıs:** Аз съм на тридесет години. (Az sım na trideset godini.) — Ben otuz yaşındayım.  
> **Örnek:** Аз имам две котки. (Az imam dve kotki.) — Benim iki kedim var.
...
| Türkçe | Bulgarca | Okunuş |
|--------|----------|--------|
| kim? | **кой?** (eril) / **коя?** (dişil) / **кое?** (nötr) | koy / koya / koe |
| ne? | **какво?** | kakvo |
| nerede? | **къде?** | kıde |
| nereye? | **накъде?** | nakıde |
| nereden? | **откъде?** | otkıde |
| ne zaman? | **кога?** | koga |
| nasıl? | **как?** | kak |
| neden? | **защо?** | zashto |
| ne kadar? | **колко?** | kolko |
| hangi? | **кой? / коя? / кое?** | koy / koya / koe |

> **Örnek:** Коя е тя? (Koya e tya?) — O kim? (kadın)  
> **Örnek:** Кой е той? (Koy e toy?) — O kim? (erkek)  
> **Örnek:** Колко струва това? (Kolko struva tova?) — Bu ne kadar?  
> **Örnek:** Откъде си? (Otkıde si?) — Nerelisin?
...
| önünde | **пред** | pred |
| arkasında | **зад** | zad |
| yanında | **до / близо до** | do / blizo do |
| karşısında | **срещу** | sreshtu |
| arasında | **между** | mezhdu |

> **Örnek:** Аз съм в офиса. (Az sım v ofisa.) — Ofisteyim.  
> **Örnek:** Книгата е на масата. (Knigata e na masata.) — Kitap masanın üzerinde.
